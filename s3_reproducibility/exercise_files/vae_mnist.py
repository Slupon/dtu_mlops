...
@hydra.main(config_path=".", config_name="default_config.yaml", version_base=None)
def train(config) -> None:
    ...
    train_dataset = MNIST("~/.pytorch/MNIST_data", transform=mnist_transform, train=True, download=False)
    test_dataset = MNIST("~/.pytorch/MNIST_data", transform=mnist_transform, train=False, download=False)
    ...
    save_image(x.view(hparams.batch_size, 1, 28, 28), os.path.join(output_dir, "orig_data.png"))
    save_image(x_hat.view(hparams.batch_size, 1, 28, 28), os.path.join(output_dir, "reconstructions.png"))
    ...
    save_image(generated_images.view(hparams.batch_size, 1, 28, 28), os.path.join(output_dir, "generated_sample.png"))
